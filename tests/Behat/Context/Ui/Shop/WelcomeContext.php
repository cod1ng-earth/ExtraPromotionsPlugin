...
namespace Tests\CodingBerlin\ExtraPromotionPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\CodingBerlin\ExtraPromotionPlugin\Behat\Page\Shop\WelcomePageInterface;
